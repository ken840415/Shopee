...
def main():    
    kw_list = ["三多偉力健綜合優蛋白","三多偉力健鉻營養素","三多偉力健女性營養素","三多偉力健LPN營養素","三多偉力健關鍵營養素","三多偉力健順暢營養素","三多偉力健均衡營養素","三多補體康c經典營養配方","三多補體康高纖高鈣營養配方"] #kw_list數量一定得跟thr_list數量相同，不然會出錯
    
    thr_list = ["725", "875", "590","590","590","675","535","1025","1150"]
